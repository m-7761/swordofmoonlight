...
const char wrn_invalidtrans[]   =
        "WARNING: ∆©Ã¿øßªÿƒÍ§Œ∑¡º∞§¨¿µ§∑§Ø§¢§Í§ﬁ§ª§ÅEÃµªÅEµ§ÅEﬁ§π) - '%s'\n";
const char wrn_notranscolor[]   =
        "WARNING: ªÿƒÍ§µ§ÅEø∆©Ã¿øß§À∞ÅE◊§π§ÅEß§¨§¢§Í§ﬁ§ª§ÅE- %s\n"
        "WARNING:   -> -P •™•◊•∑•Á•ÅE§«§Œ∆©Ã¿øßªÿƒÍ§œÃµªÅEµ§ÅEﬁ§π\n";
const char wrn_transtruecolor[] =
        "WARNING: ≤Ë¡ÅEœ•’•ÅE´•È°º∑¡º∞§«§π - %s\n"
        "WARNING:   -> -P •™•◊•∑•Á•ÅE§«§Œ∆©Ã¿øßªÿƒÍ§œÃµªÅEµ§ÅEﬁ§π\n";
const char wrn_imagehasalpha[] =
        "WARNING: •¢•ÅE’•°•¡•„•Õ•ÅE’§≠§Œ≤Ë¡ÅE«§π - %s\n"
        "WARNING:   -> -P •™•◊•∑•Á•ÅE§«§Œ∆©Ã¿øßªÿƒÍ§œÃµªÅEµ§ÅEﬁ§π\n";
const char wrn_alphaallzero[] =
        "WARNING: £¥»÷Ã‹§Œ•¡•„•Õ•ÅEœ•¢•ÅE’•°•¡•„•Õ•ÅE«§œ§ §§§Ë§¶§«§π(§π§Ÿ§∆£∞) - %s\n"
        "WARNING:   -> £¥»÷Ã‹§Œ•¡•„•Õ•ÅE•¢•ÅE’•°•¡•„•Õ•ÅE§œ«À¥˛§µ§ÅEﬁ§π\n";
const char wrn_mkdirfail[]   =
        "WARNING: Ω–Œœ¿Ë•«•£•ÅEØ•»•Í§Ú∫˚¿ÅEﬁ§ª§ÅE- %s\n"
        "WARNING:   -> -%c •™•◊•∑•Á•ÅE§«§ŒΩ–Œœ¿ËªÿƒÍ§œÃµªÅEµ§ÅEﬁ§π\n";
const char err_ropenfail[]   = "SKIPPED: ≥∫≈ˆ§π§ÅE’•°•§•ÅE¨§¢§Í§ﬁ§ª§ÅE- %s\n";
const char err_wopenfail[]   = "SKIPPED: Ω–Œœ•’•°•§•ÅEÚ∫˚‹Æ§«§≠§ﬁ§ª§ÅE- %s\n";
const char err_outofmemory[] = "SKIPPED: ∫˚“»Õ—•·•‚•Í§¨≥Œ ›§«§≠§ﬁ§ª§ÅE- %s\n";
	/* -- */
const char err_readeof[]     = "SKIPPED: •’•°•§•ÅE¨≈”√Ê§«¿⁄§ÅE∆§§§ﬁ§π - %s\n";
const char err_readerr[]     = "SKIPPED: ∆…§ﬂπ˛§ﬂ•®•È°º§¨»Ø¿∏§∑§ﬁ§∑§ø - %s\n";
const char err_not_a_bmp[]   = "SKIPPED: BMP •’•°•§•ÅE«§œ§¢§Í§ﬁ§ª§ÅE- %s\n";
const char err_invalid_hed[] =
        "SKIPPED: BMP •’•°•§•ÅEŒ•ÿ•√•¿•µ•§•∫§¨Ãµ∏˙§«§π - %s\n";
const char err_width_zero[]  = "SKIPPED: ≤Ë¡ÅEŒ…˝§¨£∞(§ﬁ§ø§œ…ÅE§«§π - %s\n";
const char err_height_zero[] = "SKIPPED: ≤Ë¡ÅEŒπ‚§µ§¨£∞(§ﬁ§ø§œ…ÅE§«§π - %s\n";
const char err_compression[] = "SKIPPED: …‘Ã¿§ ∞µΩÃ•ø•§•◊§«§π - %s\n";
const char err_invalid_bpp[] = "SKIPPED: ≤Ë¡ÅEŒøßøÙ§¨Ãµ∏˙§«§π - %s\n";
const char err_no_palette[]  = "SKIPPED: •—•ÅE√•»§¨∑ÁÕ˚¿∑§∆§§§ﬁ§π - %s\n";
#else	/* ------------------- */
const char wrn_invalidtrans[]   =
...
/*
**		BI_RGB (Ãµ∞µΩÃ) ∑¡º∞§Œ≤Ë¡ÅE«°º•ø§Ú∆…§ÅE*/
...
/*
**		BI_BITFIELDS ∑¡º∞§Œ≤Ë¡ÅE«°º•ø§Ú∆…§ÅE*/
...
/*
**		BI_RLE8/BI_RLE4 ∑¡º∞§Œ≤Ë¡ÅE«°º•ø§Ú∆…§ÅE*/
...
/*
**	•·•‚•Í§´§ÅElittle-endien ∑¡º∞ 4•–•§•»Ãµ…‰πÊ¿∞øÙ§Ú∆…§ÅE*/
...
/*
**	•·•‚•Í§´§ÅElittle-endien ∑¡º∞ 2•–•§•»Ãµ…‰πÊ¿∞øÙ§Ú∆…§ÅE*/
...
//(Also >> was sign-extending the indexes.)
//https://sourceforge.net/p/libpng/bugs/269/#
...
error_abort:				/* error */
	...
	{
		//MSVC2015 is croaking here after longjmp.
...
#define SJ_ESC(esc,raw)	raw
#endif
		"bmp2png, BMP -> PNG •≥•Û•–°º•ø - version " BMP2PNG_VERSION "\n"
		"   " BMP2PNG_COPYRIGHT "\n"
		...
		"       : ... | %s [-•π•§•√•¡] | ...\n"
		"\n"
		"∆˛Œœ•’•°•§•ÅEæ§À§œ•ÅE§•ÅE…•´°º•…§¨ª»§®§ﬁ§π (* §» ?)\n"
		"Ω–Œœ•’•°•§•ÅEæ§œ∆˛Œœ•’•°•§•ÅEæ§Œ≥»ƒ•ª“§ÅE.png §À —§®§øÃæ¡∞§À§ §Í§ﬁ§π\n"
		"\n"
		"•π•§•√•¡•™•◊•∑•Á•ÅE(æÆ ∏ª˙§«§‚≤ƒ) :\n"
		"   -0..-9   ∞µΩÃ•ÅEŸ•ÅE(•«•’•©•ÅE»§œ -6)\n"
		"   -I       •§•Û•ø°º•ÅEº•π∑¡º∞§Œ PNG •’•°•§•ÅEÚ∫˚‹Æ§π§ÅEn"
		"   -P color  ªÿƒÍ§∑§øøß§Ú∆©Ã¿øß§À§π§ÅEn"
		"             color: #RRGGBB(htmlº∞16ø ) / RR,GG,BB(10ø RGB) / NN(•—•ÅE√•»»÷πÅE\n"
		"   -F type[,...]  PNG §Œ∞µΩÃ§Àª»§ÅEÅEÅE’•£•ÅEø°¶•ø•§•◊§ÚªÿƒÍ§π§ÅEn"
		"                  type: none,sub,up,average(avg),paeth,all,auto(default)\n"
		"   -A, -B   •¢•ÅE’•°•¡•„•Õ•ÅEÚ ›¬∏§π§ÅEn"
		"   -O name  Ω–Œœ•’•°•§•ÅEæ§ÚªÿƒÍ§π§ÅEn"
		"   -D dir   •’•°•§•ÅEÚΩ–Œœ§π§ÅE«•£•ÅEØ•»•Í§ÚªÿƒÍ§π§ÅEn"
		"   -E        —¥π§¨¿Æ∏˘§∑§øæÅEÁ§À§œ∆˛Œœ•’•°•§•ÅEÚ∫ÅEÅEπ§ÅEn"
		"   -T       ∆˛Œœ•’•°•§•ÅEŒ•ø•§•‡•π•ø•Û•◊§ÚΩ–Œœ•’•°•§•ÅEÀ¿ﬂƒÍ§π§ÅEn"
		"   -Q       ΩËÕ˝√ÅE ∞ÅE⁄§Œ" SJ_ESC("…Ω\º®","…Ωº®") "§Ú§∑§ §§\n"
		"   -L       ΩËÕ˝√Ê§Œ•®•È°º§Ú•˙¡∞•’•°•§•ÅE%s)§Àµ≠œø§π§ÅEn"
		"   -X       …∏Ω‡∆˛Œœ°ø…∏Ω‡Ω–Œœ§Ú≤§∑§ø —¥π§ÚÃµ∏˙§À§π§ÅEn";
#else  /* ----------------------------------- */
...
*/
//2017: MSVC2015 won't build, because there's another instance somewhere.
