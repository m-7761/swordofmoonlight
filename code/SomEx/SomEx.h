...
#define SOMEX_VERSION 1,2,4,12
#define SOMEX_VNUMBER 0x102040cUL
#define SOMEX_VSTRING "1, 2, 4, 12"
#define SOMEX_WSTRING L"1, 2, 4, 12"
extern int SOMEX_vnumber; //0x102040cUL
#endif
