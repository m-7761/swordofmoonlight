...
#define SOMEX_VERSION 1,2,5,12
#define SOMEX_VNUMBER 0x102050cUL
#define SOMEX_VSTRING "1, 2, 5, 12"
#define SOMEX_WSTRING L"1, 2, 5, 12"
extern int SOMEX_vnumber; //0x102050cUL
#endif
