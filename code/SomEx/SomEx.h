...
#define SOMEX_VERSION 1,2,5,8
#define SOMEX_VNUMBER 0x1020508UL
#define SOMEX_VSTRING "1, 2, 5, 8"
#define SOMEX_WSTRING L"1, 2, 5, 8"
extern int SOMEX_vnumber; //0x1020506UL
#endif
