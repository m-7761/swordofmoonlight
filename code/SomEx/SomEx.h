...
#define SOMEX_VERSION 1,2,5,2
#define SOMEX_VNUMBER 0x1020502UL
#define SOMEX_VSTRING "1, 2, 5, 2"
#define SOMEX_WSTRING L"1, 2, 5, 2"
extern int SOMEX_vnumber; //0x1020502UL
#endif
