...
#define SOMEX_VERSION 1,2,6, 6
#define SOMEX_VNUMBER 0x1020606UL
#define SOMEX_VSTRING "1, 2, 6, 6"
#define SOMEX_WSTRING L"1, 2, 6, 6"
extern int SOMEX_vnumber; //0x1020606UL
#endif
